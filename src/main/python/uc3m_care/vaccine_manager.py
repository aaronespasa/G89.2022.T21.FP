...
class VaccineManager:
    ...
    class __VaccineManager:
        ...
        def request_vaccination_id(
            self, patient_id, name_surname, registration_type, phone_number, age
        ):
            """Register the patinent into the patients file"""
            my_patient = VaccinePatientRegister(
        ...
        def get_vaccine_date(self, input_file, date: str):
            ...
            my_sign = VaccinationAppointment.create_appointment_from_json_file(
                input_file, date
            )
        ...
        def vaccine_patient(self, date_signature):
            ...
            appointment = VaccinationAppointment.get_appointment_from_date_signature(
                date_signature
            )
        ...
        def cancel_appointment(self, input_file):
            ...
            date_signature = VaccinationAppointment.create_cancellation_from_json_file(
                input_file
            )
