...
param_list_ok = [
    ...
    (
        ...
        "+34333456789",
        "7",
        "0d49256644b963208cb8db044a3ebbe7",
        "test_2",
    ),
    (
        "cde0bc01-5bc7-4c0c-90d6-94c9549e6abd",
        "minombre tiene dosblancos",
        "Regular",
        "+34333456789",
        "125",
        "7fbd065ae9c274c7ccf30c50c0cd87a3",
        "test_3",
    ),
    (
        ...
        "+44333456789",
        "124",
        "76a1b7346a927ef02ad5098f673ca876",
        "test_4",
    ),
]
...
param_list_nok = [
    ...
    (
        "2b0506db-50de-493b-abf9-1fb44816b6289",
        "m m",
        "Regular",
        "+34333456789",
        "124",
    ...
    (
        ...
        "+34123456789",
        "6",
        "Registration type is nor valid",
    ...
    (
        ...
        "+34333456789",
        "7",
        "name surname is not valid",
        "test_10 name no char",
    ),
    (
        "6071d52e-ab42-452d-837c-0639367db79f",
        "minombre tienelalongitudmaximay",
        "Regular",
        "+34333456789",
        "125",
        "name surname is not valid",
...
class TestRequestVacID(unittest.TestCase):
    ...
    def test__add_family_valid_request_vaccination(self):
        ...
        patients_found = file_store.find_items_list(
            "a729d963-e0dd-47d0-8bc6-b6c595ad0098",
    ...
    def test_request_registration_type_nok(self):
        ...
        self.assertEqual(
            "Registration type is nor valid", context_manager.exception.message
        )
